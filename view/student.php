...
<body>
    ...
    <div class="full-page">
    <div class="icon">
                <img  class="logo" src="oaustech-logo.png" >
                <h2 class="schoolname">OLUSEGUN AGAGU <br> UNIVERSITY OF SCIENCE AND TECHNOLOGY <br>Department of Computer Sciences</h2>
            </div>
        <div class="navbar">
            <nav>
                <ul id="MenuItems">
                    ...
                    <li><a href="#login-page">Student</a></li>
            ...
            <div class="form-box">
                ...
                <div>
                    <form id="register" class="input-group-register">
                        ...
                        <input type="text" class="input-field" placeholder="Matric no" required>
                        <input type="int" class="input-field" placeholder="Phone Number" required>
                        <input type="date" class="input-field" placeholder="date_of_birth" required>
                        Gender:
                        <label for="Male" >Male</label>
                        <input type="radio" class="male" placeholder="male">
                        <label for="female">Female</label>
                        <input type="radio" class="female" placeholder="female">
    ...
    <!---- the first code is for tghe login and registration form to move correctly---->
    <!--script>
    ...
    <!----this code is active when you click out the login or registration page, the m-box dissapears---->
    <!---script>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p> - 2018 Scholarly. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Ravi Khadka</p>
	</div>
</div>
